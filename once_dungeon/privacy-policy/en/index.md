...
Once Dungeon (the "App") is a roguelike game about exploring a dungeon. This Policy
explains what information is collected when you use the App and how it is handled.

## 2. Information the App collects

### Information stored only on your device

Game data such as gold, held items, and dungeon exploration progress, along with your
settings, are stored only on your device. Nothing is sent externally, and this data is
erased when you delete the App.
...
The App uses Google AdMob to display ads. For ad delivery and fraud prevention, Google
...
- An approximate region estimated from your IP address
...
may be used for tracking across other apps and websites. Granting permission is
...
We may revise this Policy in response to new features or changes in law. If there is a
material change, we will update the "Last updated" date on this page.
