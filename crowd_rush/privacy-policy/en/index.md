...
Crowd Rush (the "App") is an action game where you lead a squad through stages. This
Policy explains what information is collected when you use the App and how it is handled.

## 2. Information the App collects

### Information stored only on your device

Game data such as coins, unlocked skills, and stage progress, along with your settings,
are stored only on your device. Nothing is sent externally, and this data is erased when
you delete the App.
